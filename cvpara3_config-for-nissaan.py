...
class Tracker:
    def __init__(self, 
        ...
        # self.reg_pts = [(1960, 400), (2520, 520)] if reg_pts is None else reg_pts
        # self.reg_pts = [(870, 220), (1270, 260)] if reg_pts is None else reg_pts
        # self.reg_pts = [(870, 220), (2360, 420)] if reg_pts is None else reg_pts
        # self.reg_pts = [(1370, 210), (1700, 230)] if reg_pts is None else reg_pts
        self.reg_pts = [(1370, 250), (1700, 280)] if reg_pts is None else reg_pts
        ...
        for box, track_id, xyxy in zip(boxes, track_ids, xyxys):
            ...
            if prev_position is not None and track_id not in self.count_ids:
                ...
                if distance < self.line_dist_thresh and track_id not in self.count_ids:
                    ...
                    if (box[1] - prev_position[1]) * (self.counting_region.centroid.x - prev_position[1]) > 0:
